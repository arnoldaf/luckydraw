                        ...
                        <div class="col-md-2" style="width: 20%;">
                          <table style="width:100%;">
                            ...
                            <tr>
                                ...
                                @if (array_key_exists($i, $result))
                                <td  width="40%" style="border: 1px solid; background: {{$result[$i]->amount>0?'#5ee527':'#fffb74'}};">
                                    {{$result[$i]->amount}}
                                    @php ($sum = $sum + $result[$i]->amount)
                                </td>
                                @else
        ...
        <div class="col-lg-3">
          ...
          <div class="panel panel-default">
            <div class="panel-body">
                ...
                <span><button type="button" class="btn btn-primary">Divide</button> <strong> A</strong></span>
                <div class="row show-grid">
                    <div class="col-md-12">
                      <table style="width:70%;"  >
                        ...
                        <tr>
                            ...
                            <td  width="40%" align="center" style="border: 1px solid; background: {{$andarResult[$i]->amount>0?'#5ee527':'#fffb74'}};">
                ...
                <span><button type="button" class="btn btn-primary">Divide</button> <strong> B</strong></span>
                <div class="row show-grid">
                    <div class="col-md-12">
                      <table style="width:70%;">
                        @php ($sum = 0)
...
var countDownDate = new Date("{{ date('M d, Y', strtotime(str_replace('/','-',Request::get('lotteryDate'))))}} 12:00:00").getTime();
