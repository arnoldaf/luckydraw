...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">  Game Win Result<small class="text-muted"> Search Win Users</small> </h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="mt-4 mb-4">
        <div class="col">
             {!! Form::open(array('route' => 'search-win', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
